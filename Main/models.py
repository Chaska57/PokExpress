...
def compress_and_crop_image_banner(image, quality=85, target_width=1920, target_height=1080):
    # Abrir la imagen con Pillow
    img = Image.open(image)
...
class Fish(models.Model):
    ...
    photo = models.ImageField(upload_to=get_media_path_fish, null=True, blank=True, verbose_name="Imagen del Pez")
    ...
    def save(self, *args, **kwargs):
        if self.photo:
            self.photo = compress_and_crop_image_to_468x290(self.photo)
...
class UserFish(models.Model):
    ...
    photo = models.ImageField(upload_to=get_media_path_userfish, null=True, blank=True, verbose_name="Foto del pez más bonito")
